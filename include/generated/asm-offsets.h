...
#define TSK_ACTIVE_MM 1208 /* offsetof(struct task_struct, active_mm) */
...
#define THREAD_CPU_CONTEXT 2624 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define MM_CONTEXT_ID 808 /* offsetof(struct mm_struct, context.id.counter) */
